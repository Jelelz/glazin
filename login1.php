...
if(isset($_POST['Login']))
{
    ...
    {
        //Password matching
        $query = "SELECT * FROM admin WHERE username='$un' AND enterpassword = '$pw' ";
            ...
            <div class="container vertical-center">
                <div class = "row no-pad inner-block">
                    ...
                    <div class="col-lg-7 px-5 pt-5 offset-1">
                        <div class="col-lg-11">
                        <h1 style="font-family: Roboto;" class="text-center font-weight-bold py-0 pt-0 ">Hello Admin</h1>
                        <h4 style="font-family: Roboto;" class="text-center font-weight-bold ">Log In</h4>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-row">
                                <div class="offset-2 col-lg-7">
                                    <button type="submit button" name="Login" class="btn1 mt-3 mb-4">LogIn</button>
                                </div>
                            </div>
                            <input class="offset-2" type='checkbox' name='check-box'><span>Remember Password</span><br>
                            <a class="offset-2" href="#">Forgot Password</a>
                            <!--<p class="offset-2">Don't have an account? <a href="register1.php">Register Here</a></p>-->
